...
public class DatePickerDialog extends AlertDialog implements DialogInterface.OnClickListener, DatePicker.OnDateChangedListener {
    ...
    private final DatePicker mDatePicker_start;//开始时间DatePicker
//    private final DatePicker mDatePicker_end;//结束时间DatePicker
...
//        mDatePicker_start.setFirstDayOfWeek(Calendar.SUNDAY);
